...
@FacesConverter("RefAgencyConverter")
public class RefAgencyConverter  implements Converter{
	   @EJB
	    ...
	    public Object getAsObject(FacesContext context, UIComponent component, String value) {
			...
			Object result = null;
			if (value != null) {
				result = facade.find(Integer.parseInt(value),RefAgency.class);
			}
			return result;
	    }
	    ...
	    public String getAsString(FacesContext context, UIComponent component, Object value) {
			String result = "";
			if (value != null) { 
				result = ((RefAgency) value).getAgencyId().toString();
			}
			return result;
	    }
}
